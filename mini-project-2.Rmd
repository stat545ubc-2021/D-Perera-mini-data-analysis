...
For option 3 (creating a categorical variable by grouping a numerical variable), building age will be grouped into categories by 25-year period. Groups will be: Pre-1900, 1900-1924, 1925-1949, 1950-1974, 1975-1999, and post-1999.
...
apt_buildings_age_cat %>%
  ggplot() + geom_boxplot(aes(x = age_cat, y = no_of_storeys)) +
    labs(y = "Age range", x = "Number of floors") +
...
apt_buildings_age_cat %>%
  ggplot() + geom_boxplot(aes(x = air_conditioning, y = year_built)) +
    labs(y = "Age range", x = "Type of Air Conditioning") +
...
#  ggplot(aes(ward)) + geom_bar(y = freq), position = "dodge")
